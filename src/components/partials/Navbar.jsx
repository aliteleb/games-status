        ...
        <nav className="flex justify-between items-center px-6 text-white max-h-16 bg-black bg-opacity-60">
            <div className="flex">
                <div className="cursor-pointer hover:text-gray-400 transition duration-100 ease-in-out">
                    <svg className="w-6 xl:w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="40px" width="30px">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9h16.5m-16.5 6.75h16.5" />
                    </svg>
                </div>
                <div className="ml-3 cursor-pointer hover:text-gray-400 transition duration-100 ease-in-out">
                    <svg className="w-6 xl:w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="40px">
