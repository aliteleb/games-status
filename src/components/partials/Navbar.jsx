...
function Navbar() {
    return (
        <nav className="flex justify-between items-center px-6 bg-gray-900 text-white max-h-16">
            <div className="flex">
            ...
            <div className="flex items-center">
                ...
                <div style={{ padding:'1px' }}>
                    <NavLink to="/" className="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="60" width="80px" viewBox="0 0 420 450" className="mt-1">
                            <g>
                        ...
                        <div className="cursor-auto" style={{borderLeft:'65px solid transparent', borderRight:'65px solid transparent', borderTop:'36.6px solid rgb(17 24 39)', position:'absolute', right:'50%', transform: 'translateX(50%)'}}></div>
                    </NavLink>
                </div>
