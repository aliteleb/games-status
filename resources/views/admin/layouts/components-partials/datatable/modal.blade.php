                    ...
                    @foreach($datatable->modal_fields as $name => $data)
                        ...
                        @switch($type)
                            ...
                            @case('password')
                                ...
                                <div class="form-group">
                                    <label for="{{ $name }}" class="col-form-label">@lang('datatable.'.$datatable->name.'.'.$name):</label>
                                    <input type="password" class="form-control" name="{{ $name }}" data-value-field="{{$value}}" id="{{ $name }}"
                            ...
                            @case('file')
                                ...
                                <div class="form-group">
                                    <label for="{{ $name }}" class="col-form-label">@lang('datatable.'.$datatable->name.'.'.$name):</label>
                                    <input type="file" class="form-control" name="{{ $name }}" data-value-field="{{$value}}"
                                           id="{{ $name }}"{{ $required }} {{substr($name, -2) === '[]' ? 'multiple' : ''}}>
                                </div>
                                @break
                            ...
                            @case('media')
                                ...
                                <div class="form-group">
                                    <div class="d-flex flex-column justify-center align-items-center">
                                        <img src="https://dummyimage.com/{{$data}}/8db4ff/000" data-src="https://dummyimage.com/{{$data}}/8db4ff/000"
                                             alt="@lang('datatable.'.$datatable->name.'.'.$name)" onclick="change_image(this)"
