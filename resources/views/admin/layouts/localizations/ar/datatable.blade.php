    ...
    var lang = {
        ...
        "editor": {
            ...
            "multi": {
                "title": "قيم متعدية",
                "restore": "تراجع",
                "info": "القيم المختارة تحتوى على عدة قيم لهذا العنصر. لتعديل وتحديد جميع القيم لهذا العنصر، اضغط او انتقل هنا، عدا ذلك سيبقى نفس القيم",
                "noMulti": "هذا العنصر مفرد وليس ضمن مجموعة"
            }
        },
