...
function Navbar() {
    ...
    return (
        <>
                ...
                <div className="flex items-center justify-end">
                    ...
                    {user &&
                        <div className="relative">
                            ...
                            className={`border-2 border-gray-400 mx-4 transition p-2 w-9 h-9 rounded-t-full rounded-b-full cursor-pointer ${showNotificationPopup ? "border-red-700 md:rounded-b-none md:hover:border-red-700 text-red-700" : "border-gray-600 rounded-full hover:border-gray-400"}`}
            ...
            <div
                className={`${!showProfilePopup ? "hidden " : "animate-slide-down"} backdrop-blur-lg avatar-popup z-50 w-72 my-4 text-base list-none rounded-lg shadow bg-black/60 fixed right-[.7rem] top-[3.2rem]`}
                id="user-dropdown">
            ...
            <div
                className={`${!showNotificationPopup ? "hidden" : "animate-slide-down"} sm:text-[0.8rem] text-[10px] border border-red-800 rounded-tl-none rounded-tr-none notification-popup shadow-black flex rounded-md overflow-hidden flex-col z-50 w-full md:w-[42rem] lg:w-[53rem] mt-12 md:my-[-3.5px] md:mx-[4.60rem] text-gray-300 list-none shadow bg-[#1d1c1c] fixed md:right-[0.4rem] top-[3.2rem]`}
                id="notification-dropdown">
