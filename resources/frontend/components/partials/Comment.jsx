                ...
                <form onSubmit={handleReplySubmit} ref={formRef} className="ml-20 flex flex-wrap -mt-5">
                        ...
                        <div className='flex items-center w-full'>
                            <input
                                ...
                                className="bg-transparent w-full text-sm h-10 transition ring-1 ring-gray-400/50 focus:ring-gray-500 focus:outline-none text-gray-200 px-4 pr-[10rem] mb-4 mt-2 rounded-md"
                            />
