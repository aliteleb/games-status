...
function BlurredBackground(props) {
    ...
    return (
        <div id={`blurred-bg${props.id ?? ''}`} className={`blurred-bg w-full h-screen absolute top-0 left-0 overflow-hidden z-[-1]`}>
            ...
            <img className={`opacity-30 top-[100%] w-full h-screen -scale-y-100 ${background && 'fade30'}`} src={background || '/assets/images/game-placeholder-horizontal.jpg'}
                 alt="bg"/>
            <img className={`opacity-30 top-0 w-full h-screen ${background && 'fade30'}`} src={background || '/assets/images/game-placeholder-horizontal.jpg'} alt="bg"/>
            <img className={`opacity-30 top-[100%] w-full h-screen -scale-y-100 ${background && 'fade30'}`} src={background || '/assets/images/game-placeholder-horizontal.jpg'}
                 alt="bg"/>
