...
function ReplyNotification(props) {
    ...
    return (
        <div
            onClick={seenComment}
            className={`animate-slide-down-slow flex items-center  relative cursor-pointer ${props.info.is_read ? 'bg-neutral-800/60' : 'bg-neutral-600'} bg-gradient-to-r ${!replyStatus ? "border-r-4 border-r-red-700" : ""} border border-transparent hover:bg-neutral-800/50 hover:border-red-700 transition `}>
